...
module.exports = {
    ...
    configure: function configure(environment, options) {
        ...
        if (!options.scopes) {
            options.scopes = 'openid https://uri.paypal.com/services/paypalhere address email profile https://api.paypal.com/v1/payments/.* https://uri.paypal.com/services/paypalattributes/business';
        }
